...
private JPanel mainPanel;
	...
	private void buildButtonVer() {
		...
		lblTitleBtn1 = new JLabel("Seleccionar contacto");
	...
	private void buildButtonAgregar() {
		...
		lblTitleBtn2 = new JLabel("Agregar Contacto");
	...
	private void buildButtonActualizar() {
		...
		lblTitleBtn3 = new JLabel("Actualizar Contacto");
	...
	private void buildButtonEliminar() {
		...
		lblTitleBtn4 = new JLabel("Eliminar Contacto");
		...
		JLabel lblUsuario = new JLabel("Contacto");
