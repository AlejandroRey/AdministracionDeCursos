...
public class AdministrativoABMVistaPrincipal extends JPanel {
	...
	private void buildButtonVer() {
		...
		lblIconBtn1.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/read.png")));
	...
	private void buildButtonAgregar() {
		...
		lblIconBtn2.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/create.png")));
	...
	private void buildButtonActualizar() {
		...
		lblIconBtn3.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/update.png")));
	...
	private void buildButtonEliminar() {
		...
		lblIconBtn4.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/delete.png")));
		...
		lblIconoPrincipal.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/user.png")));
		lblIconoPrincipal.setBounds(50, 93, 100, 100);
		buttonPanel.add(lblIconoPrincipal);
		
		lblHome = new JLabel("New label");
		lblHome.setIcon(new ImageIcon(AdministrativoABMVistaPrincipal.class.getResource("/presentacion/imagenes/home.png")));
