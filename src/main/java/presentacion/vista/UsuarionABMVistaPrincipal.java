...
public class UsuarionABMVistaPrincipal extends JPanel {
	...
	private void buildButtonVer() {
		...
		lblTitleBtn1 = new JLabel("Seleccionar Usuario");
	...
	private void buildButtonAgregar() {
		...
		lblTitleBtn2 = new JLabel("Agregar Usuario");
	...
	private void buildButtonActualizar() {
		...
		lblTitleBtn3 = new JLabel("Actualizar Usuario");
	...
	private void buildButtonEliminar() {
		...
		lblTitleBtn4 = new JLabel("Eliminar Usuario");
		...
		lblUsuario.setBounds(71, 56, 59, 26);
