	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.vista.getBtnIniciarSesion()) {
			...
			for (UsuarioDTO usuarioDTO : listaDeUsuarios) {
				if (usuarioDTO.getUsuario().equals(this.vista.getUsuarioField().getText())
						&& usuarioDTO.getPassword().equals(this.vista.getContraseniaField().getText())) {
			...
			if (encontrado == false) {
				JOptionPane.showMessageDialog(null, "Los datos son inválidos", "No es posible iniciar sesión",
