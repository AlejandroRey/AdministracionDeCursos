...
public class CursadaCompletaDAOSQL implements CursadaCompletaDAO {
	...
	private static final String readall = "SELECT T1.idCursada, T1.idEmpresa, T1.idCurso, T1.idEstadoCurso, T1.fechaInicioInscripcion, T1.fechaFinInscripcion, T1.vacantes, T1.fechaInicioCursada, T1.diasDeClase, T1.empresa, T1.curso, T2.nombre AS estadoCurso "
										 +"FROM (SELECT T1.idCursada, T1.idEmpresa, T1.idCurso, T1.idEstadoCurso, T1.fechaInicioInscripcion, T1.fechaFinInscripcion, T1.vacantes, T1.fechaInicioCursada, T1.diasDeClase, T1.empresa, T2.nombre AS curso "
										 +"FROM (SELECT T1.idCursada, T1.idEmpresa, T1.idCurso, T1.idEstadoCurso, T1.fechaInicioInscripcion, T1.fechaFinInscripcion, T1.vacantes, T1.fechaInicioCursada, T1.diasDeClase, T2.nombre AS empresa "
										 +"FROM cursada AS T1 "
